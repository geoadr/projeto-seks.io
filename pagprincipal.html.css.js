...
<head>
    ...
    <style>
        ...
        .photo-upload, .text-share {
            margin-bottom: 30px;
        }

        .photo-upload h2, .text-share h2 {
            color: var(--azul);
            font-size: 28px;
            margin-bottom: 15px;
            text-shadow: 1px 1px 3px var(--rosa);
        }
        ...
        .delete-button, .save-button, .like-button, .dislike-button {
            background: none;
            border: none;
            cursor: pointer;
            font-size: 24px;
        ...
        .like-button, .dislike-button, .save-button, .delete-button {
            display: inline-flex;
            align-items: center;
        }
